...
public class SwimEntryTest {
    ...
    public void testGetWhere() {
        System.out.println("getWhere first:");
        ...
        System.out.println(expResultA + " and result " + result);
        ...
        result = instanceB.getWhere(); // is this supposed to be the same var 'result' or a second one??
        System.out.println(expResultB + " and result " + instanceB.getWhere());
    ...
    public void testGetEntry() {
        ...
        System.out.println(instance.getEntry());
